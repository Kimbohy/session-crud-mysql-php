...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $stmt = $conn->prepare("UPDATE etudiant SET nom = ?, prenom = ?, date_naissance = ?, adresse = ?, parcours = ?, sexe = ? WHERE id = ?");
        // Execute the prepared statement
        if ($stmt->execute(array($nom, $prenom, $date_naissance, $adresse, $parcours_id, $sexe, $id))) {
